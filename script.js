...
// ************************************************
// AI 미션 관련 상수 및 상태 (이전 불필요한 코드 제거)
// ************************************************
...
function openMissionModal() {
    // index.html의 DOMContentLoaded와 click 리스너에서 loadMissions가 호출되므로 여기서는 모달만 엽니다.
...
// ************************************************
// AI 미션 성공 시 게임 상태 업데이트를 위한 새 함수 (index.html에서 호출됨)
// ************************************************
